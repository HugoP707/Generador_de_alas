...
GAPS = [
			...
			gaps_normalizados(C4, AOA3, [-0.5, 0.2])
		]
...
print("Cuerdas normalizadas: ")
print([foil.cuerda for foil in ala.foils])
print("AOA del alerón: " + str(ala.AOATotal))
# for foil in ala.foils:
# 	print(foil.max_extrados())

ala.plot()
ala.exportar(separadores="\t", comaDec=False, coordz=False, carpeta="tests/alaTest18v2", sameFile=False, inFileSeparador="\n\n")
# En Javafoil se ponen todos en un archivo y separados por una fila con 9999,9	9999,9
ala.exportarJavaFoil("tests/JavaFoilTests/18v2/")