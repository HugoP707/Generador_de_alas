...
##############################
# elem0U, elem0L = None
elem1U, elem1L = naca1314U, naca1314L
elem2U, elem2L = naca1317U, naca1317L
elem3U, elem3L = naca1316U, naca1316L
...
GAPS = [
			gaps_normalizados(C2, AOA1, [-0.45, 0.075]),
			gaps_normalizados(C3, AOA2, [-0.55, 0.10]),
			gaps_normalizados(C4, AOA3, [-0.6, 0.25])
		]
...
ala.plot()
ala.exportar(separadores="\t", comaDec=False, coordz=False, carpeta="tests/alaTest10", sameFile=False, inFileSeparador="\n\n")
