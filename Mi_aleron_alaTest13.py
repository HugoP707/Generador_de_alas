...
##############################
# elem0U, elem0L = None
elem1U, elem1L = naca1313U, naca1317L
...
GAPS = [
			gaps_normalizados(C2, AOA1, [-0.5, 0.075]),
			gaps_normalizados(C3, AOA2, [-0.55, 0.075]),
			gaps_normalizados(C4, AOA3, [-0.75, 0.15])
		]
...
ala.plot()
ala.exportar(separadores="\t", comaDec=False, coordz=False, carpeta="tests/alaTest13", sameFile=False, inFileSeparador="\n\n")
