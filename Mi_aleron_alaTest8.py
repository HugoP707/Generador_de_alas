...
##############################
elem1U, elem1L = jkk145145U, jkkL145145L
...
GAPS = [gaps_normalizados(C1, AOA0, [-0.2, 0.05]), gaps_normalizados(C2, AOA1, [-0.2, 0.13])]
...
ala.plot()
ala.exportar(separadores="\t", comaDec=False, coordz=False, carpeta="tests/alaTest8", sameFile=False, inFileSeparador="\n\n")
