...
elem2U, elem2L = naca1314U, naca1314L
elem3U, elem3L = naca1315U, naca1315L
elem4U, elem4L = naca1316U, naca1316L
...
GAPS = [
			gaps_normalizados(C2, AOA1, [-0.45, 0.10]),
			gaps_normalizados(C3, AOA2, [-0.45, 0.15]),
			gaps_normalizados(C4, AOA3, [-0.5, 0.25])
		]
...
ala.plot()
ala.exportar(separadores="\t", comaDec=False, coordz=False, carpeta="tests/alaTest9", sameFile=False, inFileSeparador="\n\n")
