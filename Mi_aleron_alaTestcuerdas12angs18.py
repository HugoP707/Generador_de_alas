...
GAPS = [
			gaps_normalizados(C2, AOA1, [-0.5, 0.15]),
			gaps_normalizados(C3, AOA2, [-0.5, 0.15]),
			gaps_normalizados(C4, AOA3, [-0.55, 0.3])
		]
...
ala.plot()
ala.exportar(separadores="\t", comaDec=False, coordz=False, carpeta="tests/alaTestcuerdas12angs18", sameFile=False, inFileSeparador="\n\n")
# En Javafoil se ponen todos en un archivo y separados por una fila con 9999,9	9999,9
ala.exportarJavaFoil("tests/JavaFoilTests/cuerdas12angs18/")