...
GAPS = [
			gaps_normalizados(C2, AOA1, [-0.45, 0.15]),
			gaps_normalizados(C3, AOA2, [-0.45, 0.15]),
			gaps_normalizados(C4, AOA3, [-0.45, 0.15])
		]
...
ala.plot()
ala.exportar(separadores="\t", comaDec=False, coordz=False, carpeta="tests/alaTest14", sameFile=False, inFileSeparador="\n\n")
